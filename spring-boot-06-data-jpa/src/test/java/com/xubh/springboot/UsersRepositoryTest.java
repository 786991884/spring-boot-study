...
import com.xubh.springboot.repository.*;
...
@SpringBootTest(classes = SpringBoot06DataJpaApplication.class)
public class UsersRepositoryTest {
    ...
    public void testFindByName() {
        List<Users> list = this.usersRepositoryByName.findByLastName("张三");
    ...
    public void testFindByNameAndAge() {
        List<Users> list = this.usersRepositoryByName.findByLastNameAndEmail("张三", "20");
        for (Users users : list) {
            System.out.println(users);
        }
    }
    ...
    public void testFindByNameLike() {
        List<Users> list = this.usersRepositoryByName.findByLastNameLike("张%");
        for (Users users : list) {
            System.out.println(users);
        }
    }
